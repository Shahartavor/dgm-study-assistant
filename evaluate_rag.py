...
from src.dgm_study_assistant.evaluation import RAGEvaluator, SyntheticDataGenerator
...
def load_rag_system():
    ...
    try:
        ...
        vectorstore = load_vectorstore(embedding_model, "faiss_index")
